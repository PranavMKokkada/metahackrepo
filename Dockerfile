...
COPY --chown=appuser:appuser app.py session_runtime.py baseline.py client.py data.py environment.py gym_wrapper.py inference.py models.py rubrics.py tasks.py test_api.py test_env.py ui.py validate.py openenv.yaml pyproject.toml ./
